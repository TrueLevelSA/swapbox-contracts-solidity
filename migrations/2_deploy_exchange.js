...
const createToken = (config) => {
    return TokenErc20.new(utils.stringToBytes32(config.name), utils.stringToBytes32(config.symbol), utils.numberToUint(config.decimals), utils.numberToUint(config.supply));
};
/**
